...
namespace Negadium.Developer.Miniek
{
    public class MinieksWings : ModItem
    {
        ...
        {
            item.name = "Minieks Wings";
            item.width = 24;
            item.height = 30;
            item.toolTip = "Only wearable by Miniek";
        ...
        {
            if (inUse)
                Dust.NewDust(player.position, player.width, player.height, mod.DustType("Flame"), 0, 0, 0, Color.Black);
