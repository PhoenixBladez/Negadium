...
namespace Negadium.Items.Weapons.Mharadium
{
    public class HydraHeadStaff : ModItem
    {
        ...
        {
            item.name = "Hydra Head Staff";
            item.width = 26;
            item.height = 28;
            item.toolTip = "Summons a Hydra Head to fight for you";
            ...
            item.noMelee = true;
            item.mana = 1;
            item.shoot = mod.ProjectileType("HydraHeadMinion");
            item.buffType = mod.BuffType("HydraHeadMinionBuff");
            item.buffTime = 3600;
